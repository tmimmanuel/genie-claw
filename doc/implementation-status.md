...
| --- | --- | --- | --- |
| Home Assistant integration | Partial / transitional | Provider boundary, status/control/history/undo, local action safety, HA token/config path | Home Assistant is not reimplemented in Rust here. Seasonal/device actions such as driveway ice checks, front-gate state, holiday lights, sprinklers, robot mower, porch-light arrival triggers, rain-arrival, vacation-mode, smoke-ventilation, working-late, fall-alert, and parking-lot safety routines, work-from-home/all-off/nap scenes, TV/alarm controls, fireplace/ventilation/upstairs-light controls, smoke-detector tests, lock-up/locked-out confirmation flows, phone finder, connected-car warmup/navigation, baby-monitor/iron/water-heater/status, mailbox/freezer telemetry, tire-pressure/dryer/car/stove/package/garage-door/sous-vide/sump-pump/water-pressure/nursery-air-quality/self-cleaning-oven status, solar generation status, basement/attic environment status, and slow-cooker control route through this boundary when configured. Final device graph, automations, and deterministic physical safety belong behind an external home boundary. |
